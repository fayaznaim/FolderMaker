...
namespace FayaxFolderMaker
{
    public partial class fayaxFolderMaker : Form
    {
        ...
        {
            var assembly = Assembly.GetExecutingAssembly();
                if (usStatesRbtn.Checked == true)
                {
                    var resourceName = "FayaxFolderMaker.resources.states.txt";
                    using (Stream stream = assembly.GetManifestResourceStream(resourceName))
                    {
                        using (StreamReader reader = new StreamReader(stream))
                        {
                ...
                else if (countriesRbtn.Checked == true)
                {
                    var resourceName = "FayaxFolderMaker.resources.countries.txt";
                    using (Stream stream = assembly.GetManifestResourceStream(resourceName))
                    {
                        using (StreamReader reader = new StreamReader(stream))
                        {
                ...
                else if (animalsRbtn.Checked == true)
                {
                    var resourceName = "FayaxFolderMaker.resources.animals.txt";
                    using (Stream stream = assembly.GetManifestResourceStream(resourceName))
                    {
                        using (StreamReader reader = new StreamReader(stream))
                        {
                ...
                else if (elementsRbtn.Checked == true)
                {
                    var resourceName = "FayaxFolderMaker.resources.elements.txt";
                    using (Stream stream = assembly.GetManifestResourceStream(resourceName))
                    {
                        using (StreamReader reader = new StreamReader(stream))
                        {
